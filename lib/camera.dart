  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: ListView(
            children: [
          Image.file(File(picture.path), fit: BoxFit.cover, width: 250,height: 600,),
          ...
          Center(child: ElevatedButton.icon(onPressed: (){ copyFile(picture.path, '/storage/emulated/0/Download/abcd');
